...
class MyApp(QWidget):
    ...
    def initUI(self):
        ...
        self.lbl_div23.setText(u"◆오늘 기준 23사단 예약 가능한 날짜 : ~" + div23.toString('yyyy-MM-dd dddd'))
        self.lbl_div23.setFont(font)

        # 오늘 기준 타 사단 간부 예약일자 계산
        self.lbl_divAnother = QLabel(self)
        divAnother = today.addDays(9)
        self.lbl_divAnother.setText(u"◆오늘 기준 타부대 예약 가능한 날짜 : ~" + divAnother.toString('yyyy-MM-dd dddd'))
        ...
        self.lbl_select_div23.setText(u"★23사단 예약 가능한 날짜 : " + div23_select.toString('yyyy-MM-dd dddd')+"~")
        ...
        self.lbl_select_divAnother.setText(u"★타부대 예약 가능한 날짜 : " + divAnother_select.toString('yyyy-MM-dd dddd') + "~")
        ...
        self.setWindowTitle(u'예약 일자 계산기')
        self.setWindowIcon(QIcon('23Div.png'))
